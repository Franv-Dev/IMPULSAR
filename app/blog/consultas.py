...
def hay_reporte_pendiente(reporter_id, tipo, target_id):
    ...
    objetivo: uno sin resolver ya alcanza para que el admin lo vea. MySQL no
    soporta indices UNIQUE condicionales (solo sobre resolved=0), asi que el
    chequeo queda en la aplicacion en vez de en la base.
    """
    filtro_objetivo = (
